...
class HealthChecker:
    ...
    def display_health(
        ...
        *,
        ...
        """
        # Overall status banner
        color = self.get_status_color(health.overall_status)
        icon = self.get_status_icon(health.overall_status)
        ...
        # Component table
        table = self.display_component_table(health.components)
    ...
    def display_component_table(
        ...
        for component in components:
            ...
            icon = self.get_status_icon(component.status)
    ...
    def get_status_icon(self, status: HealthStatus) -> str:
        """Get icon for status.
