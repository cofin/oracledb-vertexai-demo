...
# Base system instruction for the barista assistant
...
"""
    ...
    def get_default_instruction(cls) -> str:
        """Get the default system instruction with enthusiast persona.

        Returns:
            System instruction string with enthusiast persona applied
        """
        return cls.get_system_prompt("enthusiast", BASE_SYSTEM_INSTRUCTION)
