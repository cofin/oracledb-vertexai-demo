...
-- Created: 2025-10-07
-- Updated: 2025-10-17 - Added store table, modernized types to Oracle 23ai
-- Author: cody
...
-- Drop triggers
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER product_updated_at_trg';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;

BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER store_updated_at_trg';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;

BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER intent_exemplar_updated_at_trg';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
