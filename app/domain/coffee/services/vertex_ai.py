...
from app.domain.coffee.services.oracle_services import SearchMetricsService, ResponseCacheService
...
class VertexAIService:
    ...
    def __init__(self):
        ...
        self.metrics_service: Optional[SearchMetricsService] = None
        self.cache_service: Optional[ResponseCacheService] = None
    
    def set_services(self, metrics_service: SearchMetricsService, cache_service: ResponseCacheService):
    ...
    def create_system_message(self, message: str = None) -> str:
...
class OracleVectorSearchService:
    ...
    def __init__(self, product_service, vertex_ai_service: VertexAIService):
