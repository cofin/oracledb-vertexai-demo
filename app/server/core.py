...
class ApplicationCore(InitPluginProtocol, CLIPluginProtocol):
    ...
    def on_app_init(self, app_config: AppConfig) -> AppConfig:
        ...
        app_config.dependencies = {
            ...
            "products_service": Provide(deps.provide_product_service, sync_to_thread=False),
            "company_service": Provide(deps.provide_company_service, sync_to_thread=False),
            "shops_service": Provide(deps.provide_shop_service, sync_to_thread=False),
            "inventory_service": Provide(deps.provide_inventory_service, sync_to_thread=False),
            "session_service": Provide(deps.provide_user_session_service, sync_to_thread=False),
            "conversation_service": Provide(deps.provide_chat_conversation_service, sync_to_thread=False),
            "cache_service": Provide(deps.provide_response_cache_service, sync_to_thread=False),
            "metrics_service": Provide(deps.provide_search_metrics_service, sync_to_thread=False),
            "intent_exemplar_service": Provide(deps.provide_intent_exemplar_service, sync_to_thread=False),
            "intent_service": Provide(deps.provide_intent_service),
            "embedding_cache": Provide(deps.provide_embedding_cache, sync_to_thread=False),
            "vector_demo_service": Provide(deps.provide_vector_demo_service),
            "product_recommendation_service": Provide(
                deps.provide_product_recommendation_service
            ),
        ...
        app_config.signature_namespace.update(
            {
                ...
                "VectorDemoService": services.VectorDemoService,
                "ProductRecommendationService": services.ProductRecommendationService,
                "Request": Request,
