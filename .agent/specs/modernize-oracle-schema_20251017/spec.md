...
- [ ] Task bd-3o1.1: Update `app/db/migrations/0001_initial_schema.sql` to add `store` table.
- [ ] Task bd-3o1.2: Modernize boolean and timestamp columns in migrations.

### Phase 2: Fixtures & Application Code
- [ ] Task bd-3o1.3: Update `app/db/utils.py` fixture table order.
- [ ] Task bd-3o1.4: Update `app/domain/products/services/_product.py` for correct boolean handling.
- [ ] Task bd-3o1.5: Test fixture loading (`uv run app db load-fixtures`).

### Phase 3: Documentation & Verification
- [ ] Task bd-3o1.6: Update schema documentation and README.
- [ ] Task bd-3o1.7: Run integration tests to verify metrics and product searches.