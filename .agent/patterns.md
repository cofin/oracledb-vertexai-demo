...
- **React-First Controller Pattern:** Keep core controllers API-only (`/api/*`) and move UI rendering to SPA routes; retire template/HTMX handlers once React replacements are live.
